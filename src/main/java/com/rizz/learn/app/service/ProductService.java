...
public class ProductService {
    ...
    @Observed(name = "product.findById", contextualName = "find by id")
    ...
    // * Create
    @Transactional
    @Observed(name = "product.create", contextualName = "create product")
    ...
    @Observed(name = "product.update", contextualName = "update product")
    ...
    @CacheEvict(
            ...
            allEntries = true)
    @Observed(name = "product.delete", contextualName = "delete product")
